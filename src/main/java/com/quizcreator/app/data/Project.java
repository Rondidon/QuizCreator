...
public class Project {
	...
	public void addToAudioResourceList(AudioFile file) {
		audioResourceList.add(file);
	}

	public void deleteFromAudioResourceList(final UUID id) {
	...
	public void addToImageResourceList(ImageFile file) {
		imageResourceList.add(file);
	}

	public void deleteFromImageResourceList(final UUID id) {
